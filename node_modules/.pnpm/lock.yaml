...
importers:
  ...
  packages/app:
    specifiers:
      '@kurly-frontend/common-components': ^0.0.0
      '@types/react': ^18.0.24
      ...
      vite: ^3.2.3
    dependencies:
      '@kurly-frontend/common-components': link:../common
      react: 18.2.0
...
packages:
  ...
  /pnpm/7.16.0:
    resolution: {integrity: sha512-jGDe7kz6wmoJiiEn+zQBwV+h0PazsvkeXGS5RnM0bEAD2rTxMR+oOfhWfuEDXddiBocCDNuuo1PL4ChuvR0t/g==}
    engines: {node: '>=14.6'}
    hasBin: true
    dev: true
